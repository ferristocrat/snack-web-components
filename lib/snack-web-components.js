(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		define("snack-web-components", [], factory);
	else if(typeof exports === 'object')
		exports["snack-web-components"] = factory();
	else
		root["snack-web-components"] = factory();
})(this, function() {
...
var panelContainer = _extends({}, flexRow, {
    ...
    _createClass(Text, [{
        ...
        value: function render() {
            var _props = this.props,
                xxxlarge = _props.xxxlarge,
                xxlarge = _props.xxlarge,
            ...
            return _react2.default.createElement(
                "span",
                {
                    ...
                    style: _extends({
                        color: color || _styles.colors.text,
                        fontSize: fontSize,
                        textAlign: textAlign,
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                "button",
                {
                    onClick: this.props.onPress,
                    style: _extends({
                        backgroundColor: backgroundColor || _styles.colors.blue,
...
var filterNumber = function filterNumber(value) {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement("input", {
                    ...
                    onChange: function onChange(e) {
                        if (!_this2.props.onChangeText) {
                            return;
                        }
                        var value = e.target.value;
                        if (number && filterNumber(value)) {
                            _this2.props.onChangeText(value);
                        }
                        _this2.props.onChangeText(value);
                    },
                    type: type || "text",
...
var _TouchableHighlight = __webpack_require__(52);
...
var Toggle = function (_Component) {
    ...
    _createClass(Toggle, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement(_reactToggleButton2.default, _extends({
                colors: {
                    active: {
                        base: _styles.colors.green
                    }
                }
            }, this.props, {
                value: value || false,
                onToggle: function onToggle(value) {
                    _this2.props.onToggle(!value);
                }
            }));
        }
    }]);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_react_input_autosize__ = __webpack_require__(50);
...
*/
var aa=__webpack_require__(0),l=__webpack_require__(16),B=__webpack_require__(4),C=__webpack_require__(2),ba=__webpack_require__(17),da=__webpack_require__(18),ea=__webpack_require__(19),fa=__webpack_require__(20),ia=__webpack_require__(21),D=__webpack_require__(6);
...
var TouchableHighlight = function (_Component) {
    ...
    function TouchableHighlight() {
        ...
        return _possibleConstructorReturn(this, (TouchableHighlight.__proto__ || Object.getPrototypeOf(TouchableHighlight)).apply(this, arguments));
    }
...
var _ModalPortal = __webpack_require__(56);
...
var _scopeTab = __webpack_require__(58);
...
var _bodyClassList = __webpack_require__(60);
...
var createItemFromSchema = function createItemFromSchema(schema) {
    var ret = {};
...
var Grid = function (_Component) {
    ...
    _createClass(Grid, [{
        ...
        key: "onChangeItem",
        value: function onChangeItem(index, item) {
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    _View2.default,
                    {
                        style: _extends({}, _styles2.default.flexRow)
                    },
                    schema.map(function (key, i) {
                        return _react2.default.createElement(
                            _View2.default,
                            {
                                style: {
                            ...
                            _react2.default.createElement(
                                _Text2.default,
                                { small: true, bold: true, center: true },
                                key
                            )
                        );
                    })
                            ...
                            schema.map(function (key, j) {
                                return _react2.default.createElement(_TextInput2.default, {
                                    ...
                                    onChangeText: function onChangeText(value) {
                                        var update = {};
                                        update = _extends({}, item);
                                        update[key] = value;
                                        _this2.onChangeItem(i, update);
                                    }
                                });
                            })
                        );
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(_Button2.default, {
                        ...
                        onPress: function onPress() {
                            var newData = _this2.state.data.slice();
                            newData.push(createItemFromSchema(_this2.props.schema));
                            _this2.setState({
                                data: newData
                            });
                            _this2.handleChange(newData);
                        }
                    }),
                    _react2.default.createElement(_Button2.default, {
                        label: "Remove",
                        onPress: function onPress() {
                            if (_this2.state.data.length < 1) {
                                return;
                            }
                            var newData = _this2.state.data.slice();
                            newData.pop();
...
//# sourceMappingURL=snack-web-components.js.map